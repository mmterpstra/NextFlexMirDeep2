...
ml DigitalBarcodeReadgroups/0.1.10-GCC-10.2.0-Perl-5.32.0
perl $EBROOTDIGITALBARCODEREADGROUPS/src/NextFlexSmallRNARemove4N.pl $outDirLast/$(basename $(basename ${fqFile} .fq.gz) .fastq.gz)'_trimmed.fastq.gz'  ${outDir}/${sampleName}.fq.gz
